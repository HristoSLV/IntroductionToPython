...
# TODO: Now you need to print the greeting message using the name
#  and the number of exclamation marks.
# You need to use the String formatting techniques here.
# There are several ways to format strings in python,
# choose the one you are most comfortable with.
my_string = "Hello, {names}{nums}".format(names=name, nums=exclamations)
print(my_string)
